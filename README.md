...
Vault構造は[akira_papa_IT氏のセミナー](https://x.com/akira_papa_IT/status/1988025916333977810)で紹介されたPARA法+Zettelkastenのフレームワークをベースにしています。
...
- **Vault構造**: [akira_papa_IT](https://x.com/akira_papa_IT) — PARA法+Zettelkastenフレームワーク
